...
/** Struct used to restore Boot information. */
typedef struct
{
    uint8_t BootPolarity;               /**< 0: even boot, 1: odd boot */
    uint32_t BootPNAddr;                /**< address of boot software version  */
    uint32_t BootValidFlagAddr;         /**< address of boot software valid Flag */
    uint32_t OppositBootStartAddr;      /**< start address of opposite boot software */
    uint32_t OppositBootCRCAddr;        /**< Received TransDataInfo Flag */
    uint32_t OppositBootFlagValidAddr;  /**< Received TransDataInfo Flag */
    uint32_t OppositBootEndAddr;        /**< Received TransDataInfo Flag */
    uint32_t OppositBootValidCode;      /**< Received TransDataInfo Flag */
}MyBootSys;

/** Struct used to restore Boot sequence data. */
typedef struct
{
...
/** Struct used to restore Boot block data. */
typedef struct
{
...
/** Struct used to restore Boot info flag. */
typedef struct
{
...
/**
* Assert ModeRequest command. Be called in CMD_ModeRequest.
*
* @param Received_Message struct of received message.
* @return  Error code.
*********************************************************/
uint8_t IsRequestValid(stCanMsgObj Received_Message);

/**
* Assert LogisticRequest command. Be called in CMD_LogisticRequest.
*
* @param Received_Message struct of received message.
* @return  Error code.
*********************************************************/
...
/**
* Assert SW Version Check command. Be called in CMD_SWVersionCheck.
*
* @param Received_Message struct of received message.
* @return  Error code.
*********************************************************/
...
/**
* Assert Security Access command. Be called in CMD_SecurityAccess.
*
* @param Received_Message struct of received message.
* @return  Error code.
*********************************************************/
...
/**
* Assert Erase Memory command. Be called in CMD_EraseMemory.
*
* @param Received_Message struct of received message.
* @param ucSecurityUnlocked Flash unlock flag.
* @return  Error code.
*********************************************************/
uint8_t IsEraseValid(stCanMsgObj Received_Message, bool ucSecurityUnlocked);

/**
* Assert Transfer Information command. Be called in CMD_TransferInformation.
*
* @param Received_Message struct of received message.
* @param pSt_TransDataInfo pointer of TransDataInfo struct.
* @param stBootFlag pointer of boot information flag.
* @return  Error code.
*********************************************************/
uint8_t IsTransferInfoValid(stCanMsgObj Received_Message, St_TransDataInfo *pSt_TransDataInfo, St_BootFlag *stBootFlag);

/** Assert Transfer data command. Be called in CMD_TransferData.
*
* @param Received_Message struct of received message.
* @param pSt_TransDataInfo pointer of TransDataInfo struct.
* @return  Error code.
...
/** Assert CRC Request command. Be called in CMD_CRCRequest.
*
* @param Received_Message struct of received message.
* @return  Error code.
*********************************************************/
...
/** Logitic Request Handler. Be called in CMD_LogisticRequest.
*
* @param Identifier 0x21: OBC HW version; 0x22: OBC HW serial number.
*********************************************************/
void LogiticRequestHandle(uint8_t Identifier);

/** Compare SW version. Be called in CMD_SWVersionCheck.
*
* @param Received_Message struct of received message.
* @param Info pointer of bootinfo struct.
* @param ptr_st_BootFlag pointer of boot information flag.
*********************************************************/
void SWVersionComparetHandle(stCanMsgObj Received_Message, MyBootSys *Info, pSt_BootFlag ptr_st_BootFlag);

/** Validate writing address before write flash. Be called in TreatData.
*
* @see TreatData()
* @param Address Flash Address.
* @param MemoryArea 0x20: Application area; 0x24: Bootloader area.
* @param Info pointer of bootinfo struct.
*********************************************************/
bool CheckWritingAddress(uint32_t Address, uint8_t MemoryArea, MyBootSys *Info);

/** Verify flash CRC and write related valid flag. Be called in CMD_CRCRequest.
*
* @param ReceivedMessage struct of received message.
* @param BootStatus pointer of bootinfo struct.
* @param stBootFlag pointer of boot information flag.
*********************************************************/
void CRCWrite(stCanMsgObj ReceivedMessage, MyBootSys *BootStatus, St_BootFlag *stBootFlag);

/** Verify Logitic data and write CRC. Be called in CMD_CRCRequest.
*
* @param ReceivedMessage struct of received message.
*********************************************************/
